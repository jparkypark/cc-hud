...
export class ThoughtsSegment extends Segment {
  ...
  private loadState(): ThoughtsState {
    try {
      ...
      console.error('[chud] Failed to load thoughts state:', error);
    }
  ...
  private saveState(): void {
    try {
      ...
      console.error('[chud] Failed to save thoughts state:', error);
    }
  }
  ...
  private loadQuotesCache(): QuotesCache {
    try {
      ...
      console.error('[chud] Failed to load quotes cache:', error);
    }
  ...
  private saveQuotesCache(cache: QuotesCache): void {
    try {
      ...
      console.error('[chud] Failed to save quotes cache:', error);
    }
  }
  ...
  private async fetchApiQuotes(): Promise<string[]> {
    try {
      ...
      console.error('[chud] Failed to fetch quotes from API:', error);
      return [];
    }
  }
